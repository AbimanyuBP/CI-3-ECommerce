...
<div class="home-page">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Grafik - Penjualan tiap produk</h3><br>
                    <a href="laporanexcel" class="btn btn-success">Print Laporan</a>
                </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Grafik - Order tiap bulan</h3>
                </div>
                <div class="panel-body">
...
<script>
    ...
    type: 'column'
            ...
            subtitle: {
            text: 'Penjualan bedasarkan produk'
            },
            xAxis: {
            type: 'category'
            },
            ...
            name: 'Donat Coklat Vanila Frosting',
            data: [3]
            },{
            name: 'Moccacino',
            data: [0]
