<div id="products">
    ...
    ?>
    <h1><img src="<?= base_url('assets/imgs/products-img.png') ?>" class="header-img" style="margin-top:-2px;"> List Produk</h1>
    <hr>
    <div class="row">
        <div class="col-xs-12">
                    ...
                    <form method="GET" id="searchProductsForm" action="">
                        <div class="col-sm-4">
                            ...
                            <select name="order_by" class="form-control selectpicker change-products-form">
                                <option <?= isset($_GET['order_by']) && $_GET['order_by'] == 'id=desc' ? 'selected=""' : '' ?> value="id=desc">Terbaru</option>
                                <option <?= isset($_GET['order_by']) && $_GET['order_by'] == 'id=asc' ? 'selected=""' : '' ?> value="id=asc">Urut ascending</option>
                                <option <?= isset($_GET['order_by']) && $_GET['order_by'] == 'quantity=asc' ? 'selected=""' : '' ?> value="quantity=asc">Jumlah sedikit</option>
                                <option <?= isset($_GET['order_by']) && $_GET['order_by'] == 'quantity=desc' ? 'selected=""' : '' ?> value="quantity=desc">Jumlah banyak</option>
                            </select>
                        </div>
                        <div class="col-sm-4">
                            <label>Title:</label>
