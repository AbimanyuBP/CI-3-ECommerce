...
<h1><img src="<?= base_url('assets/imgs/shop-cart-add-icon.png') ?>" class="header-img" style="margin-top:-3px;"> Tambah Produk</h1>
<hr>
<?php
$timeNow = time();
...
<form method="POST" action="" enctype="multipart/form-data">
    ...
    foreach ($languages as $language) {
        ...
        <div class="locale-container locale-container-<?= $language->abbr ?>" <?= $language->abbr == MY_DEFAULT_LANGUAGE_ABBR ? 'style="display:block;"' : '' ?>>
            ...
            <div class="form-group"> 
                <label>Nama Produk (<?= $language->name ?><img src="<?= base_url('attachments/lang_flags/' . $language->flag) ?>" alt="">)</label>
            ...
            <div class="form-group">
                <a href="javascript:void(0);" class="btn btn-default showSliderDescrption" data-descr="<?= $i ?>">Tunjukan deskripsi slider <span class="glyphicon glyphicon-circle-arrow-down"></span></a>
            </div>
            ...
            <div class="form-group">
                <label for="description<?= $i ?>">Deskripsi produk (<?= $language->name ?><img src="<?= base_url('attachments/lang_flags/' . $language->flag) ?>" alt="">)</label>
            ...
            <div class="form-group for-shop">
                <label>Harga (<?= $language->name ?><img src="<?= base_url('attachments/lang_flags/' . $language->flag) ?>" alt="">)</label>
            ...
            <div class="form-group for-shop">
                <label>Harga lama (<?= $language->name ?><img src="<?= base_url('attachments/lang_flags/' . $language->flag) ?>" alt="">)</label>
    ...
    <div class="form-group bordered-group">
        ...
        ?>
        <label for="userfile">Foto Produk</label>
    ...
    <div class="form-group for-shop">
        <label>Jumlah</label>
        <input type="text" placeholder="Jumlah produk" name="quantity" value="<?= isset($_POST['quantity']) ? htmlspecialchars($_POST['quantity']) : '' ?>" class="form-control" id="quantity">
    </div>
    <?php if ($showBrands == 1) { ?>
        <div class="form-group for-shop">
            <label>Brand</label>
    ...
    <button type="submit" name="submit" class="btn btn-lg btn-default btn-publish">Tambah</button>
