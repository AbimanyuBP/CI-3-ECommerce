...
<div class="row">
    <div class="col-sm-6 col-md-4">
        <a href="javascript:void(0);" data-toggle="modal" data-target="#addPage" class="btn btn-default" style="margin-bottom:10px;">Tambah brand baru</a>
        <?php if (!empty($brands)) {
            ?>
        ...
        <div class="modal-content">
            <form action="" method="POST">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Tambah brand baru</h4>
                </div>
