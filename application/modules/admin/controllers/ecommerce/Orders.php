...
class Orders extends ADMIN_Controller
{
    ...
    public function printInvoice(){
        ...
        // mencetak string 
        $pdf->Cell(190,7,'Ecommerce Foodie Goodie',0,1,'C');
        $pdf->SetFont('Arial','B',12);
        $pdf->Cell(190,7,'Invoice Pembelian',0,1,'C');
        // Memberikan space kebawah agar tidak terlalu rapat
        $pdf->Cell(10,7,'Abimanyu Bevan Pramudito',0,1);
        $pdf->Cell(10,7,'41519010178',0,1);
        $pdf->Cell(10,7,'',0,1);
        $pdf->SetFont('Arial','B',10);
        $pdf->Cell(20,6,'No',1,0);
        $pdf->Cell(85,6,'Produk',1,0);
        ...
        $pdf->Cell(20,6,1,1,0);
        $pdf->Cell(85,6,'Donat Coklat',1,0);
        $pdf->Cell(27,6,1,1,0);
        $pdf->Cell(25,6,'Rp 10000',1,0);
        $pdf->Cell(25,6,'Rp 10000',1,1);
        $pdf->Cell(20,6,2,1,0);
        $pdf->Cell(85,6,'Donat Coklat Vanila Frosting',1,0);
        $pdf->Cell(27,6,2,1,0);
        $pdf->Cell(25,6,'Rp 15000',1,0);
        $pdf->Cell(25,6,'Rp 30000',1,1);
        $pdf->Cell(157,6,'Total Akhir',1,0);
        $pdf->Cell(25,6,'Rp 40000',1,1);

        $pdf->Output('I', 'invoice_41519010178.pdf');
    }
